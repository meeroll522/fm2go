          ...
          <div class="col-md-12">
            <div class="section-heading">
              <div class="line-dec"></div>
              	    <h3 class="margin" style="color:#008000";><b>Please fill in below to let us know that your booking food transaction was successful</b></h3><br>
            </div>
          </div>
          <div class="col-md-6">
            <div class="right-content">
              <div class="container">
                <form id="contact" action="processConfirm.php" method="post">
                  <div class="row">
                    <div class="col-md-12">
                      <fieldset>
                        <input type="text" class="form-control" placeholder="Complete" name="visitorConfirm" required="">
                      </fieldset>
                    </div>

                    </div>
                  </div>
				   <input type="submit" id="form-submit" name="addConfirm" value="Submit">
                </form>
              </div>
            </div>
          </div>
