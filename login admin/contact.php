  ...
  <div class="row">
          ...
          <div class="col-md-12">
            <div class="section-heading">
              <div class="line-dec"></div>
              	    <h1 class="margin" style="color:#008000 align:right";><b>Leave Your Feedback Below !</b></h1><br>
            </div>
          </div>
          <div class="col-md-6">
            <div class="right-content">
              <div class="container">
                <form id="contact" action="processFeedback.php" method="post">
                  <div class="row">
                    <div class="col-md-12">
                      <fieldset>
                    ...
                    <div class="col-md-5" >
                      <fieldset>
                         <select class="form-control" name="visitorContact" id="">
	...
	<optgroup label="Other countries">
		...
		<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
					...
					<div class="col-md-12">
					<fieldset>
                        <input type="text" class="form-control" name="visitorCountry" placeholder="Country or city of residence" required="">
                      </fieldset>
                    </div>
                    <div class="col-md-12">
                      <fieldset>
                        <textarea rows="6" class="form-control" name="visitorMessage" placeholder="Your message" required=""></textarea>
                      </fieldset>
                    </div>
                    <div class="col-md-12">
                  </div>
                  </div>
				   <input type="submit" id="form-submit" name="addFeedback" value="Submit">
                </form>
              </div>
            </div>
          </div>
