...
<nav class="navbar navbar-default">
  <div class="container">
    <div class="navbar-header">
	  ...
	  <div id="logo">
      <a class="navbar-brand" href="http://localhost/masterfolder_fm2go/fm2go/homepage.html"><img src ="FM2GO.png" width="180" height="60" ></a></div>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="http://localhost/masterfolder_fm2go/fm2go/menu/menu.php">Menu</a></li>
        <li><a href="http://localhost/masterfolder_fm2go/fm2go/login%20admin/adminHOME.php">Admin Homepage</a></li>
		<li><a href="http://localhost/masterfolder_fm2go/fm2go/menu/order/">Order</a></li>
		<li><a href="http://localhost/masterfolder_fm2go/fm2go/menu/adminStock.php">Stock</a></li>
				<li><a href="http://localhost/masterfolder_fm2go/fm2go/login%20admin/feedbackList.php">Feedback</a></li>
		<li><a href="http://localhost/masterfolder_fm2go/fm2go/login%20admin/">
...
echo '<br>';
	...
	while($row=mysqli_fetch_assoc($qry))//Display menu information
	{
		...
		$menuName = $row['menuName'];
			...
			echo '<button type="submit" name="updateMenuButton" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i>
			</button>';
			echo '</form>';
			...
			echo '<button type="submit" name="deleteMenuButton" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i> 
			</button>';
			echo '</form>';
		echo '</td>';
		//delete menu
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-6">
			...
			The service is currently in the midst of the halal application process with JAKIM. The products available in FamilyMart that are Halal 
			certified will carry the Halal logo on its packaging. For products that are imported from Japan, Korea or Taiwan, the product ingredients 
			will be vetted to ensure that no haram ingredients such as pork, lard or alcoholic substance were used.</p>
          </div>
