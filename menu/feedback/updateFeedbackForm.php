   <title>Update Feedback | FM2GO</title>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
		...
		<li><a href="http://localhost/masterfolder_fm2go/fm2go/menu/order.php">Order</a></li>
...
//updateFeedbackForm.php

$fname=$_POST['FeedbackToUpdate'];
$qry = getFeedbackInformation($fname);//call function to get detail feedback data
...
echo '<label for="fname" style="color:#008000" >First Name</label>
    <input type="text" id="fname" name="fname" placeholder="Your first name..">';
	
echo '<label for="lname" style="color:#008000" >Last Name</label>
    <input type="text" id="lname" name="lname" placeholder="Your last name..">';
	
echo '<label for="email" style="color:#008000" >Email</label>
    <input type="text" id="email" name="email" placeholder="Your email..">';
	
echo '<label for="feedback" style="color:#008000" >Feedback</label>
    <textarea id="feedback" name="feedback" placeholder="Write something.." style="height:200px"></textarea>';

echo '<br><br><input type="submit" name="updateFeedbackButton" value="Save">  ';
