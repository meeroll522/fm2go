...
<div class="container-fluid bg-1 text-center">
  <h3 class="margin">Contact Us</h3>
		<img class="w3-round" src="fmICON.png" width="250" height="250""> </a>	
</div>
...
echo '<br><label for="fname" style="color:#008000" >First Name</label>
    <input type="text" name="fname" placeholder="Your first name.." required>';
	
echo '<br><label for="lname" style="color:#008000" >Last Name</label>
    <input type="text" name="lname" placeholder="Your last name.." required>';
	
echo '<br><label for="email" style="color:#008000" >Email</label>
    <input type="text"  name="email" placeholder="Your email..">';
	
echo '<br><label for="feedback" style="color:#008000" >Feedback</label>
    <textarea name="feedback" placeholder="Write something.." style="height:200px"></textarea>';

echo '<br><br><input type="submit" name="updateFeedbackButton" value="Submit">  ';
