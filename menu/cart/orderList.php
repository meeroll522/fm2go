...
<div class=" bg-3 text-center">    
  <h3 class="margin">Please check the order owner details carefully</h3><br>
</div>
</div>  <div align="center"><a href="http://localhost/masterfolder_fm2go/fm2go/login%20admin/confirmList.php">Proceed to see complete order </a></div>
  <!-- Footer -->
<br><br>
