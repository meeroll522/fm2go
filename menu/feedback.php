  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="http://localhost/masterfolder_fm2go/fm2go/homepage.html">Homepage</a></li>
		...
		<li><a href="http://localhost/masterfolder_fm2go/fm2go/menu/feedback.php">Feedback</a></li>
...
<?php
	...
	echo '<form action = "feedback/processFeedback.php" method ="POST">';
	echo '<br><input type = "submit" name="addFeedbackButton" value ="Create Feedback" class="center-block" style="color:black">';
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
			         <div class="col-sm-8"><h3>Feedback <b>Details</b></h3></div>
