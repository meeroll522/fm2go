...
<div class="container-fluid bg-3 text-center">    
 <img class="w3-round" src="menu/menu pic/onigiriboarder.jpg" alt="Anisah" width="1050" height="350""> </a>	<br><br>

  <div class="row">
    <div class="col-sm-4">
      <p><b>Grilled Salmon<br> RM 5.30</b></p> <br>
	  <img src="menu/menu pic/salmon.jpg" alt="123" width="380" height="250">

    </div>
    <div class="col-sm-4"> 
      <p><b>Salted Salmon<br> RM 4.90</b></p> <br>
	  <img src="menu/menu pic/saltedsalmon.jpg" alt="123" width="380" height="250">
    </div>
	<div class="col-sm-4"> 
      <p><b>Chicken Mayo<br> RM 4.50</b></p> <br>
	  <img src="menu/menu pic/chickenmayo1.jpg" alt="123" width="380" height="250">
    </div>
  </div>
  <div class="row">
    <div class="col-sm-4">
     <br> <p><b>Tuna Mayo<br> RM 3.90</b></p> <br>
	  <img src="menu/menu pic/tunamayo.jpg" alt="123" width="380" height="250">
