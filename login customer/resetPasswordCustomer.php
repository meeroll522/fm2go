...
<html>
<head>
	<title>Reset password | FM2GO</title>
	<meta charset="UTF-8">
...
<body>
	...
	<form method="post" action="">
		...
		<div class="input-group"><div class="container-login100-form-btn">
			<br><button type="submit" class="login100-form-btn" name="resetPassword">Reset password</button><br>
		</div>
...
<?php
    ...
    $message = '
        ...
        http://localhost/masterfolder_fm2go/fm2go/verifyPasswordCustomer.php?email=' . $_POST['email'] . '&password=' . $_POST['password'] . '
