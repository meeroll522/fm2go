...
<div class="container-fluid bg-3 text-center">    
 <img class="w3-round" src="menu/menu pic/odenboarder.jpg" alt="Anisah" width="1050" height="350""> </a>	<br><br>
     ...
     <br> <p><b>Fish Ball Set<br> RM 2.00</b></p> <br>
	  ...
	  <br>
        ...
        <div class="col-xs-12 col-sm-12">
           ...
           <br><br> <p class="active">ADDITIONAL ADD ONS<p>GET 50% OFF ON ALL ADD ON ITEMS</p></p>
