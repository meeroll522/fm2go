...
if(!$con)
 ...
 $visitorTotal = $_POST['total_Price'];
 ...
 //$item_price = $item["quantity"]*$item["price"];
  ...
  $sql="INSERT INTO book(visitorReference, visitorName, visitorEmail, visitorContact, visitorDate, visitorQuantity)
	VALUES ('$visitorReference','$visitorName','$visitorEmail','$visitorContact','$visitorDate','$quantity')";
