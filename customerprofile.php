...
<?php
	...
	if (isset($_POST['logout'])) {
	  header("Location: masterfolder_fm2go/fm2go/login%20customer/login.php");
	}
                  ...
                  <div class="list-menu">
                    ...
                    <div class="intro-inner">
                      <ul id="nav-menu">
						...
						<li><a href="http://localhost/masterfolder_fm2go/fm2go/cart/index.php?action=add&code=3DcAM78">Your Cart</a></li>
