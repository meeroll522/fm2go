...
$qry = getMenuInformation($menuName);//call function to get detail menu data
...
echo '<br>';
echo '<br>Type: ';
echo "<input type='text' name='menuType' value='$menuType'>";
echo '<br>';
echo '<br>Menu Price : ';
echo "<input type='number' name='menuPrice' value='$menuPrice' step='0.01'>";
echo '<br>';
echo '<br>Menu Quantity : ';
echo "<input type='text' name='menuQuantity' value='$menuQuantity'>";
