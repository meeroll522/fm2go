...
<nav class="navbar navbar-default">
  <div class="container">
    <div class="navbar-header">
      ...
      <!--<a class="navbar-brand" href="StaffHome.php"><img src="fm2go.png"/></a>-->
	   <div id="logo">
...
<div class="container-fluid bg-1 text-center">
  ...
  <!---<img src="fm2go-icon.png" class="img-responsive img-circle margin" style="display:inline" alt="Bird" width="350" height="350">--->
  <img src="fm2go-icon.png" style="display:inline" alt="Bird" width="350" height="350">
