...
<body>
  ...
  <p class="w3-xxlarge" align ="center">Welcome back Staff! Log in below to access system</p><br>
	...
	<form method="post" action="login.php">
		...
		<div class="form-input"><div class="wrap-input100 validate-input m-b-16" data-validate="Please enter password">
			<input class="input100" type="password" name="password" placeholder="Enter your password">
				...
				<a href="http://localhost/masterfolder_fm2go/fm2go/staff/resetPasswordStaff.php" class="txt2">
							 Password?
						</a><br>
