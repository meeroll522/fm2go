...
<div class="container-fluid bg-3 text-center">    
 <img class="w3-round" src="menu/menu pic/menu.png" alt="Anisah" width="1050" height="350""> </a>	<br><br>
  ...
  <div class="row">
    <div class="col-sm-4">
      <p><a href="http://localhost/masterfolder_fm2go/sandwich%20menu.php">Sandwiches</a></p> <br>
	  <img src="menu/menu pic/s1.png" alt="Anisah" width="290" height="250"> 

    </div>
    <div class="col-sm-4"> 
      <p><a href="http://localhost/masterfolder_fm2go/bread.php">Bakery Bread</a></p> <br>
