...
<div class="container-fluid bg-3 text-center">    
 <img class="w3-round" src="menu/menu pic/menu.png" alt="Anisah" width="1050" height="350""> </a>	<br><br>

  <div class="row">
    <div class="col-sm-4">
      <p><a href="http://localhost/masterfolder_fm2go/fm2go/sandwich%20menu.php">Sandwiches</a></p> <br>
	  <img src="menu/menu pic/s1.png" alt="Anisah" width="290" height="250"> 

    </div>
    <div class="col-sm-4"> 
      <p><a href="http://localhost/masterfolder_fm2go/fm2go/bread.php">Bakery Bread</a></p> <br>
	  <img src="menu/menu pic/b1.png" alt="Anisah" width="290" height="250">
    </div>
	<div class="col-sm-4"> 
      <p><a href="http://localhost/masterfolder_fm2go/fm2go/coffee.php">Coffee</a></p> <br>
	  <img src="menu/menu pic/c1.png" alt="Anisah" width="290" height="250">
    </div>
  </div>
  <div class="row">
    <div class="col-sm-4">
     <br><p><a href="http://localhost/masterfolder_fm2go/fm2go/Oden.php">Oden</a></p><br>
	  <img src="menu/menu pic/o1.png" alt="Anisah" width="290" height="250">

    </div>
    <div class="col-sm-4"> 
          <br><p><a href="http://localhost/masterfolder_fm2go/fm2go/onigiri.php">Onigiri</a></p><br>
	  <img src="menu/menu pic/onigiri.png" alt="Anisah" width="290" height="250">
	  
    </div>
	<div class="col-sm-4"> 
      <br><p><a href="http://localhost/masterfolder_fm2go/fm2go/hotsnacks.php">Hot Snacks</a></p><br>
	  <img src="menu/menu pic/hot1.png" alt="Anisah" width="290" height="250">

      </div>
	  <div class="col-sm-4"> 
      <br><p><a href="http://localhost/masterfolder_fm2go/fm2go/steamedsnacks.php">Steamed Snacks</a></p><br>
	  <img src="menu/menu pic/stem1.png" alt="Anisah" width="290" height="250">

      </div>
	  <div class="col-sm-4"> 
      <br><p><a href="http://localhost/masterfolder_fm2go/fm2go/salad.php">Salad</a></p><br>
	  <img src="menu/menu pic/salad.png" alt="Anisah" width="290" height="250">

      </div>
	  <div class="col-sm-4"> 
      <br><p><a href="http://localhost/masterfolder_fm2go/fm2go/bento.php">Bento Boxes</a></p><br>
	  <img src="menu/menu pic/bento.png" alt="Anisah" width="290" height="250">

      </div>
	  <div class="col-sm-4"> 
      <br><p><a href="http://localhost/masterfolder_fm2go/fm2go/icecream.php">Soft Serve Ice Cream</a></p><br>
	  <img src="menu/menu pic/ice1.png" alt="Anisah" width="290" height="210">

      </div>
	  <div class="col-sm-4"> 
      <br><p><a href="http://localhost/masterfolder_fm2go/fm2go/desserts.php">Desserts</a></p><br>
