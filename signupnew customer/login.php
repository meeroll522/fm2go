...
if(isset($_POST['signup']))
{
	...
	values ('$name','$fname','$lname','$email','$hash2','$contact','$hash')");
		...
		if($msg){
			...
			http://localhost/masterfolder_fm2go/fm2go/verification/verify.php?email=' . $_POST['email'] . '&hash=' . $hash . ' 
  ...
  <p class="w3-xxlarge" align ="center">Welcome to FM2GO ! </p><br>
	...
	<form method="post" action="login.php">
		...
		<br><div class="sign-up"><div class="container-login100-form-btn">
			<br><button type="submit" class="login100-form-btn" name="signup" value='Sign Up' < a href="http://localhost/masterfolder_fm2go/fm2go/login%20customer/login.php" class="txt1">SIGN UP</button><br><br>
			
		</div>
		<div class="text-center p-t-13 p-b-23">
						<a href="http://localhost/masterfolder_fm2go/fm2go/login%20customer/login.php" class="txt1">
